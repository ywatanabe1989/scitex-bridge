...
"""Tests for scitex_bridge._stats_vis module."""
...
class TestAddStatsToFigureModel:
    """Tests for add_stats_to_figure_model function."""
...
# --------------------------------------------------------------------------------
# End of Source Code from: /home/ywatanabe/proj/scitex-code/src/scitex/bridge/_stats_vis.py
# --------------------------------------------------------------------------------
