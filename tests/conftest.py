...
downstream fixtures a home. The subprocess-coverage wiring is layered
on top: see skill leaf 05_development_06_subprocess-coverage.md.
"""
...
def _ensure_subprocess_coverage_shim() -> None:
    ...
    pth = purelib / "_scitex_bridge_subprocess_coverage.pth"
    shim = (
        "import os, coverage\n"
